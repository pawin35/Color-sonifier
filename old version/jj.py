...
class MainApp (wx.Frame):
	...
	def CreateUi(self):
		...
		self.inner = wx.Frame(self)
		self.video = ShowCapture(self.inner,cc)
		self.inner.Show()
...
#		sizer.Add(self.video, pos=(0, 0),span=(5,5))
...
if __name__ == "__main__":
	...
	#frame_vid = wx.Frame(None)
#	Video = ShowCapture(frame_vid, cc)
	#frame_vid.Show()
	app.MainLoop()