...
class ShowCapture (wx.Panel):
	...
	def NextFrame(self, frame):
		...
		print(self.imgVideo.shape)
		displayWidth, displayHeight = self.parent.GetSize()
		print(self.GetSize())
		...
		print(self.imgWorking.shape)
		self.bmpVideo = wx.Bitmap.FromBuffer(width, height, self.imgWorking)
		self.Refresh()
...
class MainApp (wx.Frame):
	...
	def CreateUi(self):
		...
		self.videoPanel = ShowCapture(panel)
		self.bmpVideo = None
