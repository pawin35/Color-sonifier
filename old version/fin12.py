...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	h_avg = numpy.average(hsv[238:242, 318:322, 0])
	v_avg = numpy.average(hsv[238:242, 318:322, 2])
	...
	if abs(prior_h - h_avg) > 1 and abs(prior_s - s_avg) > 5:
		...
		pass
	s_avg = numpy.average(hsv[238:242, 318:322, 1])
	cv2.rectangle(image, (235,315), (245, 325), (255,0,0), 2)
